...
// Lazy load the charts to prevent initial loading issues
const Charts = React.lazy(() => import("@ant-design/charts"));
const { Line: AntLine, Bar: AntBar, Pie: AntPie } = Charts;
	...
	return (
		<Spin spinning={loading}>
			<div className="p-6">
				...
				<Suspense fallback={<Spin />}>{renderCharts()}</Suspense>
			</div>
		</Spin>
	);
};
